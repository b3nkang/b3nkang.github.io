...
function App({ titlecardSpacerHeight }) {
  ...
  return (
    <div className='overallContainer'>
      ...
      <Spacer color={bwgrad20} height="100vh" />
      <BWGradientWave
        overallGradStyling={{marginTop:"-100vh"}} 
        spacerHeight={462} 
        indexMod={1} 
        colorArray={[bwgrad20, bwgrad19, bwgrad18, bwgrad17, bwgrad16, bwgrad15, bwgrad13, bwgrad11, bwgrad10, bwgrad9, bwgrad7, bwgrad3]} 
